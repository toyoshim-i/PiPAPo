# xtensa.cmake — Common setup for Xtensa targets
#
# Include AFTER project() in each Xtensa target's CMakeLists.txt.
# Expects PPAP_ROOT to be set by the caller.
#
# Provides:
#   - ppap_xtensa_target_common(target): common include dirs + test support
...
# Kernel source lists (ARCH_XTENSA_SOURCES, KERNEL_SHARED_SOURCES, etc.)
# Depends on PPAP_ENABLE_* options defined in user.cmake
include(${CMAKE_CURRENT_LIST_DIR}/kernel.cmake)

# ppap_xtensa_target_common(target)
#
# Adds standard include dirs and PPAP_TESTS support to an Xtensa target.
