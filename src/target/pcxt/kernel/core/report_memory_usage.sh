...
#   0x00600-0x0B5FF  Core .text/.rodata/.data/.bss   (45056 B)
...
CORE_DS0_LIMIT_HEX=0xB600        # Core image must end before VFS data
...
# between 0x0600 and 0xB600 (the VFS data reservation starts at 0xB600).
...
printf "  core image in DS=0:        %6d / %5d bytes (%s)   [0x0600..0xB600]\n" \
