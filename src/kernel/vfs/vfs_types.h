...
/* ── VFS API ────────────────────────────────────────────────────────────────
 *
 * Module functions (vfs_init, vfs_mount, vfs_lookup, vfs_alloc_vnode, etc.)
 * are declared in mod/mod_vfs.h.  External callers should include that
 * header.  This file only provides types and constants.
 */
