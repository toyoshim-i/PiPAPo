...
void z80_add_a(z80_state_t *cpu, uint8_t val) {
  ...
  if (((cpu->a ^ val ^ res8) & 0x10)) cpu->f |= FLAG_H;
  if ((~(cpu->a ^ val) & (cpu->a ^ res8)) & 0x80) cpu->f |= FLAG_PV;
...
uint8_t z80_dec8(z80_state_t *cpu, uint8_t val) {
  ...
  cpu->f = (cpu->f & FLAG_C) /* preserve carry */
           | (res & FLAG_35) /* F3, F5 from result */
           | FLAG_N | ((res == 0) ? FLAG_Z : 0) | (res & 0x80) /* S */
...
void z80_adc_hl(z80_state_t *cpu, uint16_t val) {
  ...
  cpu->f = ((res16 >> 8) & (FLAG_S | FLAG_35)) | ((res16 == 0) ? FLAG_Z : 0) |
           ((result > 0xFFFF) ? FLAG_C : 0) |
           ((((hl ^ val ^ res16) >> 8) & 0x10) ? FLAG_H : 0) |
...
void z80_sbc_hl(z80_state_t *cpu, uint16_t val) {
  ...
  cpu->f = ((res16 >> 8) & (FLAG_S | FLAG_35)) | FLAG_N |
           ((res16 == 0) ? FLAG_Z : 0) | ((result > 0xFFFF) ? FLAG_C : 0) |
           ((((hl ^ val ^ res16) >> 8) & 0x10) ? FLAG_H : 0) |
           ((((hl ^ val) & (hl ^ res16)) >> 8) & 0x80 ? FLAG_PV : 0);
...
void z80_rlca(z80_state_t *cpu) {
  ...
  cpu->a = (cpu->a << 1) | carry;
  cpu->f = (cpu->f & (FLAG_S | FLAG_Z | FLAG_PV)) | (cpu->a & FLAG_35) | carry;
}
...
void z80_rla(z80_state_t *cpu) {
  ...
  cpu->f =
      (cpu->f & (FLAG_S | FLAG_Z | FLAG_PV)) | (cpu->a & FLAG_35) | new_carry;
}
...
void z80_daa(z80_state_t *cpu) {
  ...
  if ((cpu->f & FLAG_H) || (a & 0x0F) > 9) correction |= 0x06;
  if (carry || a > 0x99) {
    correction |= 0x60;
    carry = FLAG_C;
  }
...
void z80_scf(z80_state_t *cpu) {
  ...
  cpu->f = (cpu->f & (FLAG_S | FLAG_Z | FLAG_PV)) | f35 | FLAG_C;
  /* H = 0, N = 0 */
}
...
void z80_ccf(z80_state_t *cpu) {
  ...
  cpu->f = (cpu->f & (FLAG_S | FLAG_Z | FLAG_PV)) | f35 |
...
static uint8_t cb_flags(z80_state_t *cpu, uint8_t res, uint8_t carry) {
  cpu->f = (res & (FLAG_S | FLAG_35)) | z80_parity_table[res] |
           ((res == 0) ? FLAG_Z : 0) | carry;
  return res;
}
...
void z80_bit(z80_state_t *cpu, uint8_t bit, uint8_t val) {
  ...
  cpu->f = (cpu->f & FLAG_C) | FLAG_H |
           (result ? (result & FLAG_S) : (FLAG_Z | FLAG_PV)) | (val & FLAG_35);
}
