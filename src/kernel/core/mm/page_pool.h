/*
 * page_pool.h — Pure page-allocator core (no locking, no klogf)
 *
 ...
 * tests/host/test_page_pool.c.  page.c wraps these entry points with
 * SPIN_PAGE and adds klogf messages for OOM and double-free events.
 */

#ifndef PPAP_KERNEL_CORE_MM_PAGE_POOL_H
#define PPAP_KERNEL_CORE_MM_PAGE_POOL_H
...
uint32_t pool_block_count(void);
void pool_block_get(uint32_t idx, page_id_t *base, uint16_t *pages);
#endif

#endif /* PPAP_KERNEL_CORE_MM_PAGE_POOL_H */
