/*
 * cpm_host.h — CP/M subsystem memory image setup interface
 *
...
#ifndef PPAP_KERNEL_CORE_SUBSYS_CPM_CPM_HOST_H
#define PPAP_KERNEL_CORE_SUBSYS_CPM_CPM_HOST_H
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_CPM_CPM_HOST_H */
