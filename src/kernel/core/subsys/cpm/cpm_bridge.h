...
#ifndef PPAP_KERNEL_CORE_SUBSYS_CPM_CPM_BRIDGE_H
#define PPAP_KERNEL_CORE_SUBSYS_CPM_CPM_BRIDGE_H
...
int cpm_trap_handler(cpu_state_t *cpu, int trap_type, uint32_t param,
                     void *ctx);
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_CPM_CPM_BRIDGE_H */
