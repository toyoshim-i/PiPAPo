...
#ifndef PPAP_KERNEL_CORE_SUBSYS_PPAP_PPAP_M68K_BRIDGE_H
#define PPAP_KERNEL_CORE_SUBSYS_PPAP_PPAP_M68K_BRIDGE_H
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_PPAP_PPAP_M68K_BRIDGE_H */
