...
#ifndef PPAP_KERNEL_CORE_SUBSYS_SOS_SOS_BRIDGE_H
#define PPAP_KERNEL_CORE_SUBSYS_SOS_SOS_BRIDGE_H
...
int sos_trap_handler(cpu_state_t *cpu, int trap_type, uint32_t param,
                     void *ctx);
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_SOS_SOS_BRIDGE_H */
