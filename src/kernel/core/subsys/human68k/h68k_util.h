...
#ifndef PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_H68K_UTIL_H
#define PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_H68K_UTIL_H
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_H68K_UTIL_H */
