/*
 * human68k_util.h — Human68k path translation and error code mapping
 *
 * Pure utility functions with no kernel dependencies beyond errno.h.
 * Separated so host tests can compile them directly.
 */

#ifndef PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_HUMAN68K_UTIL_H
#define PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_HUMAN68K_UTIL_H
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_HUMAN68K_UTIL_H */
