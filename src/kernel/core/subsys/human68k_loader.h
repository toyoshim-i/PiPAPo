/*
 * human68k_loader.h — Human68k binary loader interface
 *
 * Declares common loader setup functions for Human68k X-format (.x) and
 * R-format (.r) binaries.
 */

#ifndef PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_LOADER_H
#define PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_LOADER_H
...
#endif /* PPAP_KERNEL_CORE_SUBSYS_HUMAN68K_LOADER_H */
