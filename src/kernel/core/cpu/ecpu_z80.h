...
#ifndef PPAP_KERNEL_CORE_CPU_ECPU_Z80_H
#define PPAP_KERNEL_CORE_CPU_ECPU_Z80_H
...
static inline uint8_t z80_read_r8(z80_state_t *cpu, uint8_t code) {
  switch (code) {
    ...
    case 5:
      return cpu->l;
    case 6:
      return z80_read8(cpu, z80_hl(cpu));
    case 7:
      return cpu->a;
    default:
      return 0;
...
#endif /* PPAP_KERNEL_CORE_CPU_ECPU_Z80_H */
