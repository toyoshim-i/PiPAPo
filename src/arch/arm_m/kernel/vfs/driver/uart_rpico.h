...
#ifndef PPAP_ARCH_ARM_M_KERNEL_VFS_DRIVER_UART_RPICO_H
#define PPAP_ARCH_ARM_M_KERNEL_VFS_DRIVER_UART_RPICO_H
...
#endif /* PPAP_ARCH_ARM_M_KERNEL_VFS_DRIVER_UART_RPICO_H */
