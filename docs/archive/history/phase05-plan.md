...
- [PicoPiAndPortable Design Spec v0.4](PicoPiAndPortable-spec-v06.md) — §3.5 (Loopback), §3.8 (UFS), §3.9 (FS Layout), §3.10 (fstab)
- [Phase 4 Plan](phase04-plan.md) — Block device abstraction, VFS write extensions, VFAT driver
