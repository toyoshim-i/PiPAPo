...
int main(void)
{
    ...
    UT_ASSERT(str_contains(out, "pdb> x/4b 0x0100"),
    ...
    UT_ASSERT(str_contains(out, "0x00000102: 0x0e"),
              "output should include byte-form memory output");
