...
int main(void)
{
    ...
    tests[1] = "/bin/test_elf";
    tests[2] = "/bin/test_vfork";
    tests[3] = "/bin/test_fault";
    tests[4] = "/bin/test_pipe";
    tests[5] = "/bin/test_brk";
    tests[6] = "/bin/test_fd";
    tests[7] = "/bin/test_signal";
    tests[8] = "/bin/test_poll";
    tests[9] = "/bin/test_sleep_intr";
    tests[10] = "/bin/test_orphan";
    tests[11] = "/bin/test_id";
    tests[12] = "/bin/test_fs";
    tests[13] = "/bin/test_rw";
    tests[14] = "/bin/test_time";
    tests[15] = "/bin/test_iov";
    tests[16] = "/bin/test_stat";
    tests[17] = "/bin/test_tmpfs";
    tests[18] = "/bin/test_x68k";
    tests[19] = "/bin/test_cpm";
    tests[20] = "/bin/test_trace";
    tests[21] = "/bin/test_h68k_dos";
    tests[22] = (void *)0;
